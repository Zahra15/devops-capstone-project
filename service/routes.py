...
def read_accounts(account_id):
    """
    Read an account
    This endpoint will read account details based on the id
    """
    app.logger.info("Request to read an Account wit id: %s", account_id)
...
def update_accounts(account_id):
    """
    Upadate an account
    This endpoint will update an account details based on the id
    """
    app.logger.info("Reqest to update an account with id: %s", account_id)
